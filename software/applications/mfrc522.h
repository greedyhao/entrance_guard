...
static const byte MFRC522_firmware_referenceV0_0[] = {
...
static const byte MFRC522_firmware_referenceV1_0[] = {
...
// Version 2.0 (0x92)
// NXP Semiconductors; Rev. 3.8 - 17 September 2014; 16.1.1 self-test
static const byte MFRC522_firmware_referenceV2_0[] = {
...
static const byte FM17522_firmware_reference[] = {
...
void PCD_WriteRegister_1Bit(enum PCD_Register reg, byte value);
void PCD_WriteRegister(enum PCD_Register reg, byte count, byte *values);
byte PCD_ReadRegister_1Bit(enum PCD_Register reg);
...
enum StatusCode PCD_TransceiveData(byte *sendData, byte sendLen, byte *backData, byte *backLen, byte *validBits, byte rxAlign ,bool checkCRC);
enum StatusCode PCD_CommunicateWithPICC(byte command, byte waitIRq, byte *sendData, byte sendLen, byte *backData, byte *backLen, byte *validBits, byte rxAlign, bool checkCRC);
